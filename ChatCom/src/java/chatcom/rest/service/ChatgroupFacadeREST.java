...
public class ChatgroupFacadeREST extends AbstractFacade<Chatgroup> {
    ...
    @PersistenceContext(unitName = "ChatComPU")
    ...
    public void create(Chatgroup entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Chatgroup entity) {
        super.edit(entity);
    }
